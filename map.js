...
// See example of popups on hover at https://docs.mapbox.com/mapbox-gl-js/example/popup-on-hover/
    ...
    var popup = new mapboxgl.Popup({ 
     ...
     //popup.setHTML("<h2>Walk Score:" + point[0].properties.walkscore+"</h2>"+"<h2>Bike Score:" + point[0].properties.bikescore+"</h2>"+"<p>Tree Percentage" + point[0].properties.tree_per+"</p>"+"<img src='https://drive.google.com/uc?export=view&id="+point[0].properties.SVI+"' width=200>"+"img src='https://drive.google.com/uc?export=view&id="+point[0].properties.pspnet+"' width=200 >"+"img src='https://drive.google.com/uc?export=view&id="+point[0].properties.maskrcnn+"' width=200 >");
